  ...
  return (
    <div>
        ...
        <div className='flex items-center justify-center'>
            <div className='w-11/12 mt-10 flex flex-wrap space-x-16' >
            ...
            <div className='see-all-tag cursor-pointer p-4 w-64 rounded-full flex border-2 border-gray-500 mb-5 hover:bg-gradient-to-r from-blue-600 to-purple-700'>
